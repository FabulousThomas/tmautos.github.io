            ...
            <div class="col-md-4 form-container">
               ...
               <form action="#" class="request-form">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="address" id="home_address" placeholder="Home Address" autocomplete="off">
                  </div>
                  <div class="d-flex">
                     <div class="form-group mr-2">
                        <label for="" class="label">Car Type</label>
                        <input type="text" class="form-control" id="car_type" name="car_type" placeholder="Jeep, SUV, etc....">
                     </div>
                     <div class="form-group ml-2">
                        <label for="" class="label">Car Color</label>
                        <input type="text" class="form-control" id="car_color" name="car_color" placeholder="White, Blue, Black, Red...">
                     </div>
                  </div>
                  <div class="d-flex">
                     <div class="form-group mr-2">
                        <label for="" class="label">Car Name</label>
                        <input type="text" class="form-control" id="car_name" name="car_name" placeholder="Chevrolet, Honda, BMW etc..">
                     </div>
                     <div class="form-group ml-2">
                  ...
                  <div class="form-group">
                     <label for="" class="label">Car Information</label>
                     <textarea class="form-control" rows="4" name="car_info" placeholder="Car Information"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     <input type="submit" value="Submit &rarr;" class="btn btn-primary px-4" name="sell_btn">
                  </div>
               </form>
            </div>
            <div class="col-md-8">
               <h2 class="text-dark text-center">Better Ways to Sell Your Car</h2>
               <div class="row">
